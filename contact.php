<<?php
    ...
    if (isset($_POST['nom'], $_POST['prenom'], $_POST['email'], $_POST['sujet'], $_POST['message'])) {
        ...
        /*
        Il faut configurer le serveur de messagerie 
        ...
        */
        ...
        if(mail($to, $subject, $message, $headers)){
            var_dump('Message envoyé avec succées');
        }else
        {
            var_dump('Serveur messagerie non configurer ');
        }
        ...
        <div class="col-12 col-sm-12 col-md-7 col-lg-5 col-xl-5">
            ...
            <form action="" method="POST" class="mb-5">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" id="sujet" rows="10" name="message" placeholder="Saisir votre message"></textarea>
                </div>
